...
public class Differ {
    public static LinkedHashMap<String, Triple<String, Object, Object>> getDescriptionKeys(Map<String, Object> map1,
                                                                                           Map<String, Object> map2) {
        TreeMap<String, Object> mixture = new TreeMap<>(map1);
        mixture.putAll(map2);
        LinkedHashMap<String, Triple<String, Object, Object>> descriptionKeys = new LinkedHashMap<>();
    ...
    public static String generate(Path filePath1, Path filePath2, String formatName) throws Exception {
        ...
        LinkedHashMap<String, Triple<String, Object, Object>> descriptionKeys = getDescriptionKeys(map1, map2);
